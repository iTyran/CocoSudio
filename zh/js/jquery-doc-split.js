...
jQuery(function ($) {
    ...
    //添加返回目录按钮 
    $('body').append('<a href="cheatsheet.html" title="返回 jQuery中文参考手册 速查表" style="position:fixed;top:50px;right:5px;text-decoration:none;font-size:14px;font-weight:bold;">速查表</a>' +
